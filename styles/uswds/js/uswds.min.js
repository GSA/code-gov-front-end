...
})(
  {
                ...
                if (
                  ...
                  (f.add = function() {
                    for (
                      ...
                      (t = e[n] + ''), -1 === a(this, t) && (this.push(t), (o = !0)), ++n < r;
    ...
    3: [
      function(t, e, n) {
        'use strict'
        var r
        e.exports = ((r = document.createElement('div')).setAttribute('data-a-b', 'c'),
        Boolean(r.dataset && 'c' === r.dataset.aB)
          ? function(t) {
              return t.dataset
            }
          : function(t) {
    ...
    5: [
      function(t, r, o) {
        ...
        !(function() {
          ...
          for (t = 1; t < 25; t++) n.keys[111 + t] = 'F' + t
          var e = ''
          for (t = 65; t < 91; t++)
        ...
        ;(function(t) {
          ...
          function v(t) {
            return (
              ...
              (!!(e = t) && 'object' == (void 0 === e ? 'undefined' : n(e)) && d.call(t) == o)
            )
            var e
          }
          function x(t) {
          ...
          p.exports = function(r, o, t) {
            ...
            function n() {
              ...
              if (((i = arguments), (u = this), (f = e), n)) {
                if (void 0 === s) return (l = t = f), (s = setTimeout(h, o)), d ? p(t) : a
                if (v) return (s = setTimeout(h, o)), p(f)
              }
            ...
            return (
              ...
              E(t) &&
                ((d = !!t.leading),
                (c = (v = 'maxWait' in t) ? g(x(t.maxWait) || 0, o) : c),
            ...
            var n = (function(t, e) {
              ...
              o && ((t = o[1]), (n = o[2])),
                'object' === (void 0 === e ? 'undefined' : u(e)) &&
                  (r = { capture: l(e, 'capture'), passive: l(e, 'passive') })
              var i = {
                selector: n,
    ...
    14: [
      function(t, e, n) {
        ...
        var i = { Alt: 'altKey', Control: 'ctrlKey', Ctrl: 'ctrlKey', Shift: 'shiftKey' }
        ;(e.exports = function(o) {
          ...
          return function(n) {
            var r = (function(t, e) {
              var n = t.key
              if (e) for (var r in i) !0 === t[i[r]] && (n = [r, n].join('+'))
              return n
            })(n, t)
    ...
    16: [
      function(t, e, n) {
        ...
        e.exports = function(t, e) {
          ...
          return 1 === (t = u(t).split(i)).length && '' === t[0]
            ? []
            : t.map(function(t) {
                var e = n(t)
          ...
          b = i(
            r(
              ...
              r({}, l, function(t) {
                t.preventDefault(),
                  p(this),
                  'true' === this.getAttribute(d) && (c(this) || this.scrollIntoView())
              })
            ),
            {
              init: function(t) {
            ...
            r({}, l, function() {
              if (window.innerWidth < 480) {
                ...
                e.classList.toggle(s),
                  u(d, e.closest(f)).forEach(function(t) {
      ...
      function(t, e, n) {
        ...
        var u = t('receptor/ignore'),
          ...
          l = function(t, e) {
            ...
            if (!r) throw new Error('No ' + s + ' found for search toggle in header!')
            if (((t.hidden = e), (r.hidden = !e), e)) {
              ...
              var i = u(r, function() {
                f &&
                  ...
                  document.body.removeEventListener(c, i)
              })
              setTimeout(function() {
    ...
    32: [
      function(t, e, n) {
        ...
        e.exports = function(t, e) {
          return o(t, r({ on: i('init', 'add'), off: i('teardown', 'remove') }, e))
        }
      },
      ...
      function(t, e, n) {
        ...
        e.exports = function(t) {
          var e,
            ...
            u = a(c({ Tab: i.tabAhead, 'Shift+Tab': i.tabBack }, o))
          return s(
            { keydown: u },
            {
              init: function() {
    ...
    35: [
      function(t, e, n) {
        ...
        e.exports = function(t, e) {
          ...
          var n
          ;(e &&
            ((n = e) && 'object' === (void 0 === n ? 'undefined' : o(n)) && 1 === n.nodeType)) ||
            (e = window.document)
    ...
    39: [
      function(t, e, n) {
        ...
        e.exports = function(s) {
          ...
          if (!f) throw new Error('No validation element found with id: "' + e + '"')
          Object.entries(t).forEach(function(t) {
            ...
            if (n.startsWith('validate')) {
              var o = n.substr('validate'.length).toLowerCase(),
                ...
                u = '[data-validator="' + o + '"]',
                c = f.querySelector(u)
              if (!c) throw new Error('No validator checkbox found for: "' + o + '"')
