...
*/
      ...
      function(require, module, exports) {
          ...
          if (!selectLabel || !selectLabel.matches('label[for="'.concat(selectId, '"]'))) {
            throw new Error(
              ''
                ...
                .concat(selectId, ' is either missing a label or a "for" attribute')
            )
          } else {
        ...
        var displayList = function displayList(el) {
          ...
          for (var i = 0, len = selectEl.options.length; i < len; i += 1) {
            ...
            if (
              optionEl.value &&
              (disableFiltering || isPristine || !inputValue || regex.test(optionEl.text))
            ) {
      ...
      function(require, module, exports) {
        ...
        var displayYearSelection = function displayYearSelection(el, yearToDisplay) {
          ...
          previousYearsBtn.innerHTML = Sanitizer.escapeHTML(
            _templateObject4 || (_templateObject4 = _taggedTemplateLiteral(['&nbsp']))
          ) // create next button
          ...
          nextYearsBtn.innerHTML = Sanitizer.escapeHTML(
            _templateObject5 || (_templateObject5 = _taggedTemplateLiteral(['&nbsp']))
      ...
      function(require, module, exports) {
        ...
        function toggleModal(event) {
          ...
          body.style.paddingRight =
            body.style.paddingRight === TEMPORARY_PADDING ? INITIAL_PADDING : TEMPORARY_PADDING // Handle the focus actions
        ...
        var setUpAttributes = function setUpAttributes(baseComponent) {
          ...
          var forceUserAction = baseComponent.hasAttribute(FORCE_ACTION_ATTRIBUTE)
            ? baseComponent.hasAttribute(FORCE_ACTION_ATTRIBUTE)
            : false // Rebuild the modal element
        ...
        modal = behavior(
          _defineProperty(
            ...
            CLICK,
            ((_CLICK = {}),
            _defineProperty(_CLICK, OPENERS, toggleModal),
            _defineProperty(_CLICK, CLOSERS, toggleModal),
            _CLICK)
          ),
          {
            init: function init(root) {
        ...
        var updateSortLabel = function updateSortLabel(header) {
          ...
          var headerLabel = ''
            ...
            .concat(
              isSorted
                ? ''.concat(
                    sortedAscending ? 'sorted '.concat(ASCENDING) : 'sorted '.concat(DESCENDING)
                  )
                : 'unsorted'
            )
        ...
        var showToolTip = function showToolTip(tooltipBody, tooltipTrigger, position) {
          ...
          var calculateMarginOffset = function calculateMarginOffset(
            ...
            var offset =
              offsetMargin(trigger, 'margin-'.concat(marginPosition)) > 0
                ? tooltipBodyOffset - offsetMargin(trigger, 'margin-'.concat(marginPosition))
                : tooltipBodyOffset
            return offset
          }
          /**
          ...
          var positionLeft = function positionLeft(e) {
            ...
            e.style.margin = '-'
              ...
              .concat(tooltipTrigger.offsetLeft > e.offsetWidth ? leftMargin : -leftMargin, 'px') // adjust the margin
          }
          /**
    ...
    44: [
      ...
      { './active-element': 42, './behavior': 43, './select': 49, 'object-assign': 5, receptor: 11 }
    ],
    45: [
      function(require, module, exports) {
        'use strict'
